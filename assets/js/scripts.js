...
function init() {
    ...
    //     document.getElementsByClassName("blur-text").addClasses("body.load-complete");
    // }, 1000);

    // $('#blur_text').delay(1000).queue(function() {
    //     $(this).addClass("body.load-complete");
    // });

    // window.setTimeout(function() {
    //     document.getElementsByClassName("blur-text")[3].addClass("blur-text-add");
    // }, 500);
